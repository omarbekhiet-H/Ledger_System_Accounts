...
class JournalEntryManagementWindow(QWidget):
...
#=======================================================================================#
    ...
    def perform_search(self):
        ...
        for row, entry in enumerate(entries):
            table.setItem(row, 0, QTableWidgetItem(entry['entry_number']))
            table.setItem(row, 1, QTableWidgetItem(entry['entry_date']))
            table.setItem(row, 2, QTableWidgetItem(entry['description']))
    ...
    def load_user_dates_info(self, entry_details):
        ...
        if entry_details.get('created_by'):
            created_by_user = self.lookup_manager.get_user_by_id(entry_details['created_by'])
            created_by_name = created_by_user['full_name'] if created_by_user else "غير معروف"
        ...
        if entry_details.get('created_at'):
            created_at = QDateTime.fromString(entry_details['created_at'], Qt.ISODate)
        ...
        if entry_details.get('updated_by'):
            updated_by_user = self.lookup_manager.get_user_by_id(entry_details['updated_by'])
            updated_by_name = updated_by_user['full_name'] if updated_by_user else "غير معروف"
        ...
        if entry_details.get('updated_at'):
            updated_at = QDateTime.fromString(entry_details['updated_at'], Qt.ISODate)
...
#==================================================================#        
        ...
        self.created_at_input.clear()
        self.updated_by_input.clear()
        self.updated_at_input.clear()
#===================================================================#
...
if __name__ == '__main__':
    ...
    print("DEBUG: Creating and showing JournalEntryManagementWindow...")
    try:
        window = JournalEntryManagementWindow(
