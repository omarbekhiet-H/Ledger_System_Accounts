# ui/financial/closing_steps_dialog.py (الملف الجديد)
...
class ClosingStepsDialog(QDialog):
    ...
    def start_step_1(self):
        ...
        # نحتاج إلى تاريخ بداية ونهاية لحساب الربح
        year_start_date = self.end_date[:4] + "-01-01"
        self.pre_tax_profit = self.journal_manager.calculate_net_income(year_start_date, self.end_date)
